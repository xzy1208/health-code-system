...
<div id="header" class="container-fluid" style="background-color:#375A87;height: 60px;">
    <h2>校级信息管理</h2>
    <label>欢迎您,校级管理员 ${username}</label>
</div>
<div class="main">
    <div id="leftbar">
        <div class="dropdown">
            ...
            <form action="select2" method="post">
	            <ul class="dropdown-link">
	                <li><button class="dropdown-item" value="1" name="option">学院信息查询</button></li>
    ...
    <div id="rightbar">
        ...
        <form id="ss"action="information2.do" method="post">
            <div class="icon2">
		 ...
		 <table class="table table-striped table-hover hidden" id="table2">
			...
			<tbody>
				...
				<tr>
		            ...
		            <td>${x.academy}</td>
		            <td>${x.role}</td>
		            <c:if test="${x.role=='院级管理员'}" var="result">
