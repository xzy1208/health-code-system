...
<body>
	...
	<div class=ewm style="width:300px;height:300px;margin: 10px auto;border: 10px solid rgb(255, 255, 255);"></div>
	<div class="footer">需居家医学观察或集中隔离14天不得进入校园</div>
</body>
</html>